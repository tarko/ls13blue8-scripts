/* 
 * Modified by Tarko Tikan to be totally silent and send (only relevant) things to syslog
 * Compile using "cc -Wall -ansi -pedantic -std=c99 exec-notify.c -static" for
...
int main(int argc, char **argv)
{
	...
	*mcop_msg = PROC_CN_MCAST_LISTEN;
	...
	//	"Hit Ctrl-C to exit\n");
	openlog ("psexec", LOG_CONS | LOG_PID | LOG_NDELAY, LOG_LOCAL1);
